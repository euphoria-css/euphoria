...
Euphoria provides common styling classes for creating user interfaces in CSS-in-JS projects. Euphoria generates CSS that can be injected into a webpage, for example using [glamor][glamor] (which all the following examples refer to). You can use Euphoria however you like of course.
...
- Make it easy to:
  - Tweak the defaults (colors, fonts, etc)
  - Add custom styles that extend defaults (`.button`, `.input`, etc)
  - Document styles (default and custom)
  - Selectively use only the styles I want
